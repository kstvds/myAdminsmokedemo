...
public class Search_reservation_by_producttype_visa {
	...
	ExtentTest test;
	Logger logger = Logger.getLogger("Visa_Booking");
	...
	public void Search_Reservation_Visa() throws Exception {
		Actions action;
		...
		test = rep.startTest("Search_Reservation_Visa");
		try {
