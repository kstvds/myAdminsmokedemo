...
public class View_Reservationof_ServiceType_Transfer {
	...
	public void searchaccomodation() throws Exception {
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Transfer/Transfer_booking_for_adults_with_children/Selected-transfer type-available-book-transfer.jpg");
			Thread.sleep(1000);
			...
			obj.Takesnap(driverqa,
					"D:/Test Repository/Test Screenshots/Transfer/Transfer_booking_for_adults_with_children/Passenger-Details-transfer-book.jpg");
			driverqa.findElement(NewAccoBooking.bookBtn).click();
			logger.info("Entered Passenger details");
			Thread.sleep(4000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Transfer/Transfer_booking_for_adults_with_children/Confirm-Booking-transfer-book.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Transfer/Transfer_booking_for_adults_with_children/Reservation-productType-transfers.jpg");
			Assert.assertTrue(result.contains(expected));
