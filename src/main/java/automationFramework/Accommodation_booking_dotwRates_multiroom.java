...
public class Accommodation_booking_dotwRates_multiroom {
	...
	public void bookdotwmultiroom(String browsername) throws Exception {
		test = rep.startTest("bookdotwmultiroom");
		...
		try {
			 ...
			 * Thread.sleep(2000);
			 */
			driverqa.findElement(MultiAccoDOTW.Plusroom).click();
			
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccoDOTW.adult1));
			
			Select adult1 = new Select(driverqa.findElement(MultiAccoDOTW.adult1));
			adult1.selectByIndex(0);
			
			Select adult2 = new Select(driverqa.findElement(MultiAccoDOTW.adult2));
			adult2.selectByIndex(0);
			
			
			wait.until(ExpectedConditions.visibilityOfElementLocated(NewAccoBooking.bookChannel));
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_dotwRates_multiroom/Search-Hotel-filters.jpg");
			driverqa.findElement(NewAccoBooking.bookChannel).click();
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccoDOTW.OfflineContract));
			driverqa.findElement(MultiAccoDOTW.OfflineContract).click();
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation_booking_dotwRates_multiroom/Search-Result.jpg");
		...
		try {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccoDOTW.DOTWroomOne));
			driverqa.findElement(MultiAccoDOTW.DOTWroomOne).click();
			logger.info("Room Type 1 Selected");
						
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccoDOTW.DOTWroomTwo));
			driverqa.findElement(MultiAccoDOTW.DOTWroomTwo).click();
			logger.info("Room Type 2 Selected");
			
			test.log(LogStatus.INFO, "Start Booking");
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accommodation_booking_dotwRates_multiroom/Selected-room-available.jpg");
			Thread.sleep(1000);
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccoDOTW.DOTWTWOroomProcede));
			driverqa.findElement(MultiAccoDOTW.DOTWTWOroomProcede).click();
			Thread.sleep(2000);
			...
			Thread.sleep(3000);
			obj.Takesnap(driverqa,
					"D:/Test Repository/Test Screenshots/Accommodation_booking_dotwRates_multiroom/Passenger-Details.jpg");
			driverqa.findElement(NewAccoBooking.bookBtn).click();
			logger.info("Entered Passenger details");
			Thread.sleep(4000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accommodation_booking_dotwRates_multiroom/Confirm-Booking.jpg");
			...
			Thread.sleep(2000);*/
			wait.until(ExpectedConditions.visibilityOfElementLocated(MultiAccoDOTW.confirmStatus1));
			String actualbookingstatus1 = driverqa.findElement(MultiAccoDOTW.confirmStatus1).getText();
			String actualbookingstatus2 = driverqa.findElement(MultiAccoDOTW.confirmStatus2).getText();
			String expectedbookingstatus = "Confirmed";
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accommodation_booking_dotwRates_multiroom/After-booking.jpg");
